...
- - - -
# Descrizione
Appunti del corso di **Fondamenti di Informatica** per l’anno accademico **2020/2021**.
Professore: [Daniele Loiacono](https://loiacono.faculty.polimi.it/). Scaglione IMA-MEZ.
Creato da **Mario Merlo**. Per altri appunti, visita [questo link](https://drive.google.com/drive/folders/1QtwmHc2g6OOoqPsdemR0nkbfHPmJH37E).
Se ci sono errori, per favore comunicatemelo [aprendo un Issue sulla repository](https://github.com/MrVideo/mrvideo.github.io/issues).
- - - -
# Indice
